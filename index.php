     ...
     <!---------------------------- jQuery library ------------------------------->
                ...
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse text-center" id="mymenu">
                    <ul class="navbar-nav ml-auto">
                       <li class="nav-item">
                        <a class="nav-link text-white"href="signup.php"><i class="fas fa-user">Sign_Up</i></a></li>
                        <li class="nav-item">
                        <a class="nav-link text-white" href="login.php"><i class="fas fa-sign-in-alt">Login</i></a></li>
                    </ul>
                </div>
              </nav>
            </header>
      ...
      <div class="container">
        <div class="banner-content">
          <button class="btn btn-danger text-white bnt-lg"><a href="product.php">SHOP NOW</button></a>
        </div>
      </div>
