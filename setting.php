        ...
        <body>
          <div class="bgpic">
            ...
            <div class="container center_div shadow">
                 <div class="heading text-center mb-5 text-wight"></div>
                 <div class=" container row d-flex flex.row justify-content-center mb-5">
                   <div class="admin-form shadow">
                     <form action="" method="POST">
                       <div class="form-group">
                         <label for="email">)Old-Password:</label>
                         <input type ="password" name="email" value=""class="form-control" id="email" required>
                       </div>
                       <div class="form-group">
                       ...
                       <a href="signup.php"><h3 class="font-italic text-red lead text-justify text-center">Don't have an account? Register</a>
